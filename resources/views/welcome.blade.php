                                    ...
                                    <tbody>
                                        <tr v-for="shipping in shippings" v-if="shipping.tracking">
                                            ...
                                            <td>
                                                ...
                                                @endif
                                                @if(\Auth::user()->role_id < 3)
                                                <a title="Etiqueta" v-if="shipping.is_finished == 1 && shipping.shipped_at != null" :href="'{{ url('/shippings/qr') }}'+'/'+shipping.id" class="btn btn-info" target="_blank"><i class="far fa-file-pdf"></i></a>
                                                @endif
