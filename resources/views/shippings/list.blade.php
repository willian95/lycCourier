                            ...
                            <tbody>
                                <tr v-for="shipping in shippings">
                                    ...
                                    <td>
                                        ...
                                        <a title="Editar"  v-if="selectedShippings.length == 0 && shipping.is_finished == 0" :href="'{{ url('/shippings/show') }}'+'/'+shipping.tracking" class="btn btn-info"><i class="far fa-eye"></i></a>
