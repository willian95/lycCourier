                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="shipping in shippings">
                                    ...
                                    <td>
                                        <button class="btn btn-success" data-toggle="modal" data-target="#shippingModal" @click="edit(shipping)" v-if="shipping.shipping_tatus_id < 5" ><i class="far fa-edit"></i></button>
