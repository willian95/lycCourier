    ...
    <script>
        const devArea = new Vue({
            ...
            data() {
                return {
                    recipients:[],
                    recipientId:"{{ $shipping->recipient_id }}",
                    recipientQuery:"",
                    recipientShowName:"{{ $shipping->recipient->name }}",
                    packages:[],
                    packageId:"{{ $shipping->box_id }}",
                    packageQuery:"",
            ...
            methods: {
                ...
                update(){
                    ...
                    this.loading = true
                    axios.post("{{ url('/shippings/pending/update') }}", {recipientId: this.recipientId, packageId: this.packageId, tracking: this.tracking, description: this.description, pieces: this.pieces, length: this.length, height: this.height, width: this.width, weight: this.weight, shippingId: this.shippingId})
                    .then(res => {
                        this.loading = false
