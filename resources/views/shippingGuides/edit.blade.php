            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Editar guía<h3>
                    </div>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr v-for="shipping in shippings" v-if="shipping.tracking">
                                            <td >
                                                <input v-if="!shipping.shipping_guide || shipping.shipping_guide.id == shippingId" type="checkbox" class="form-check-input" @click="selectShipping(shipping)" :checked="checkTest(shipping)">
                                            </td>
            ...
            methods: {
                ...
                async update(){
                    ...
                    try{
                        ...
                        this.errors = []
                        this.loading = true
                        let response = await axios.post("{{ url('shipping-guide/update') }}", {guide: this.guide, shippings: shippingsId,id: this.shippingId})
                        this.loading = false
