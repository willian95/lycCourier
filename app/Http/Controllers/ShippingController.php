    ...
    function search(Request $request){
        ...
        try{
            ...
            if(\Auth::user()->role_id < 3){
                ...
                $shippings = Shipping::where("reseller_id", \Auth::user()->id)->with("recipient", "box", "shippingStatus", "shippingHistories", "shippingHistories.user", "shippingHistories.shippingStatus", "shippingGuideShipping", "shippingGuideShipping.shippingGuide")
                ->where(DB::raw("CONCAT(`tracking`, ' ', `warehouse_number`)"), "like", '%'.$request->search.'%')
                ->take($dataAmount)->skip($skip)
                ->orderBy("id", "desc")
                ->with(['box' => function ($q) {
                    $q->withTrashed();
                }])
                ...
                $shippingsCount = Shipping::where("reseller_id", \Auth::user()->id)->with("recipient", "box", "shippingStatus", "shippingHistories", "shippingHistories.user", "shippingHistories.shippingStatus", "shippingGuideShipping", "shippingGuideShipping.shippingGuide")
                ->where(DB::raw("CONCAT(`tracking`, ' ', `warehouse_number`)"), "like", '%'.$request->search.'%')
                ->with(['box' => function ($q) {
                    $q->withTrashed();
                }])
    ...
    function fetch($page = 1){
        ...
        try{
            ...
            if(\Auth::user()->role_id < 3){
                ...
                $shippings = Shipping::where("reseller_id", \Auth::user()->id)->with("recipient", "box", "shippingStatus", "shippingGuideShipping", "shippingGuideShipping.shippingGuide", "shippingHistories.user", "shippingHistories.shippingStatus")->take($dataAmount)->skip($skip)->orderBy("id", "desc")
                ->with(['box' => function ($q) {
                    $q->withTrashed();
                }])
                ->with(["client" => function($q){
                ...
                $shippingsCount = Shipping::where("reseller_id", \Auth::user()->id)->with("recipient", "box", "shippingStatus", "shippingGuideShipping", "shippingGuideShipping.shippingGuide", "shippingHistories.user", "shippingHistories.shippingStatus")->with(['box' => function ($q) {
                    $q->withTrashed();
                }])
                ->with(["client" => function($q){
                    $q->withTrashed();
